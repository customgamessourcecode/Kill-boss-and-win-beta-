LinkLuaModifier("modifier_meepo_divided_we_stand_lua","divided_we_stand.lua",LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_meepo_divided_we_stand_death_lua","divided_we_stand.lua",LUA_MODIFIER_MOTION_NONE)
...
function modifier_meepo_divided_we_stand_lua.OnIntervalThink(self)
    ...
    if mainMeepo~=meepo then
        local boots = {"item_travel_boots2","item_travel_boots","item_guardian_greaves","item_power_treads","power_treads_2","power_treads_3","item_arcane_boots","item_phase_boots","item_phase_boots_2","item_phase_boots_3","item_tranquil_boots","item_boots"}
        local item = ""
