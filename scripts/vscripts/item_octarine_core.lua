...
LinkLuaModifier( "modifier_imba_octarine_core_basic", "item_octarine_core.lua", LUA_MODIFIER_MOTION_NONE )	-- Item stats
LinkLuaModifier( "modifier_imba_octarine_core_unique", "item_octarine_core.lua", LUA_MODIFIER_MOTION_NONE )	-- Lifesteal + magus presence handler
