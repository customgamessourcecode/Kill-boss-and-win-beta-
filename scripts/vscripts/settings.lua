...
FOUNTAIN_PERCENTAGE_HEALTH_REGEN = 200   -- What should we use for the percentage fountain health regen?  Use -1 to keep the default dota behavior.
...
STARTING_GOLD = 600                     -- How much starting gold should we give to each player?
...
AUTO_LAUNCH_DELAY = 9                 -- How long should the default team selection launch timer be?  The default for custom games is 30.  Setting to 0 will skip team selection.
