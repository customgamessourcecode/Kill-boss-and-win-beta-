...
local items = {
	...
	["item_tome_un_6"]				 = { [1] = 50, [2] = 1, [3] = 3, [4] = 6 },
	["item_angels_blood"]			 = { [1] = 60, [2] = 1, [3] = 1, [4] = 5 },
...
function SetBossessDrop(monster_table, item_table)
	...
	SetMonsterDropOfTable(monster_table, "Demon_possessed", "item_awful_mask", item_table)
	SetMonsterDropOfTable(monster_table, "Demon_possessed", "item_angels_armor", item_table)
	SetMonsterDropOfTable(monster_table, "Demon_possessed", "item_tome_un_60", item_table)
	SetMonsterDropOfTable(monster_table, "Demon_possessed", "item_icarus", item_table)
	SetMonsterDropOfTable(monster_table, "Demon_possessed", "item_branches", item_table)
