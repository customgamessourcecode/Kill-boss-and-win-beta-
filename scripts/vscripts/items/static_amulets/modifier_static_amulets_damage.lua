modifier_static_amulets_damage = class({})
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
function modifier_static_amulets_damage:IsHidden()
    return true
end

--------------------------------------------------------------------------------
function modifier_static_amulets_damage:IsPurgable()
    return false
end

--------------------------------------------------------------------------------
function modifier_static_amulets_damage:DestroyOnExpire()
    return false
end

--------------------------------------------------------------------------------
function modifier_static_amulets_damage:DeclareFunctions()
    local funcs = {
...
--------------------------------------------------------------------------------
function modifier_static_amulets_damage:OnCreated()
...
--------------------------------------------------------------------------------
function modifier_static_amulets_damage:OnAbilityExecuted(keys)
    ...
    print("caster: ",caster)
    print("self:GetParent(): ",self:GetParent())


    if (static_ability:GetToggleState()) or (not caster) or (not (caster == self:GetParent()))then return end
    print("GO")
    ...
    DealDamageAroundCaster(caster, damage_pct, damage, manacost, ability)
